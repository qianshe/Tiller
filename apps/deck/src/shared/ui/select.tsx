...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 max-h-96 min-w-32 overflow-hidden rounded-md bg-surface-elevated text-foreground shadow-ambient ring-1 ring-border-ghost data-[state=open]:animate-in data-[state=closed]:animate-out",
        position === "popper" &&
