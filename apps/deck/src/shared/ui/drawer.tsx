  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content fixed z-50 flex h-auto flex-col bg-surface-elevated",
      ...
      >
        {showHandle ? (
          <div className="mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full bg-border-strong/70 group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        ) : null}
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
