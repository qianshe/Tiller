          ...
          <div className="fleet-hub-head">
            ...
            <div>
              ...
              <div className="fleet-hub-title-row">
                {" "}
                <h3>Helm</h3> <span>{helmCards.length} Helm</span>{" "}
              </div>{" "}
            </div>{" "}
            {!isEmbeddedHelmDeck ? (
              <button
            ...
            <section className="helm-inventory-list-section">
              ...
              <div className="helm-inventory-section-head">
                ...
                <button
                  ...
                  aria-label="添加项目"
                  title="添加项目"
                  onClick={() => setFleetProjectFormOpen((current) => !current)}
                >
                  {" "}
                  +{" "}
                </button>{" "}
                    ...
                    <li key={project.id}>
                      ...
                      <details className="helm-simple-detail-row">
                        ...
                        <dl>
                          ...
                          <div>
                            {" "}
                            <dt>Helm ID</dt> <dd>{project.helmId}</dd>{" "}
                          </div>{" "}
                          <div>
                            {" "}
                            <dt>默认分支</dt>{" "}
                    ...
                    <li key={agent.id}>
                      ...
                      <details className="helm-simple-detail-row">
                        ...
                        <dl>
                          ...
                          <div>
                            {" "}
                            <dt>Command</dt> <dd>{agent.command}</dd>{" "}
                          </div>{" "}
                          <div>
                            {" "}
                            <dt>Arguments</dt>{" "}
                          ...
                          <div>
                            {" "}
                            <dt>Protocol</dt> <dd>{agent.protocol}</dd>{" "}
                          </div>{" "}
                        </dl>{" "}
                      </details>{" "}
                    </li>
