...
export function MissionPaneResizer({
  ...
  return (
    <button
      type="button"
      className={`mission-pane-resizer mission-pane-resizer-${handle} ${gridColumnClass} group relative z-20 w-1.5 cursor-col-resize rounded-full bg-transparent transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40 max-[1080px]:hidden after:absolute after:inset-y-3 after:left-1/2 after:w-px after:-translate-x-1/2 after:rounded-full after:bg-border-ghost after:transition hover:after:bg-primary focus-visible:after:bg-primary`}
      role="separator"
